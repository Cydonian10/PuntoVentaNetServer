        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InitSale = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    TotalSale = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Igv = table.Column<decimal>(type: "decimal(2,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shopping_Providers_ProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProviderProducto", x => new { x.ProductsId, x.ProvidersId });
                    table.ForeignKey(
                        name: "FK_ProviderProducto_Products_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProviderProducto_Providers_ProvidersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShoppingItems_Shopping_ShoppingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    UnitPrice = table.Column<decimal>(type: "decimal(4,2)", nullable: false),
                    UnitMeasurement = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProviderProducto_ProvidersId",
                table: "ProviderProducto",
                column: "ProvidersId");

            migrationBuilder.CreateIndex(
                name: "IX_Shopping_ProviderId",
                table: "Shopping",
                column: "ProviderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingItems_ShoppingId",
                table: "ShoppingItems",
                column: "ShoppingId");
